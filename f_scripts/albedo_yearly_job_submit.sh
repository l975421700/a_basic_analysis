...
# /albedo/work/user/qigao001/a_basic_analysis/f_scripts/0_echam_pp/0.7_get_6h_wisoq_sfc.sh ${SLURM_ARRAY_TASK_ID} /albedo/scratch/user/qigao001/output/echam-6.3.05p2-wiso/pi nudged_711_6.0_S6

# /albedo/work/user/qigao001/a_basic_analysis/f_scripts/0_echam_pp/0.8_get_6h2monthly_wisoq.sh ${SLURM_ARRAY_TASK_ID} /albedo/scratch/user/qigao001/output/echam-6.3.05p2-wiso/pi nudged_701_5.0
