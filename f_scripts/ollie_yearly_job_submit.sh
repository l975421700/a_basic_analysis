...
# /work/ollie/qigao001/a_basic_analysis/f_scripts/0_echam_pp/0.0_get_monthly_uvq_plev.sh ${SLURM_ARRAY_TASK_ID} output/echam-6.3.05p2-wiso/pi pi_m_502_5.0
