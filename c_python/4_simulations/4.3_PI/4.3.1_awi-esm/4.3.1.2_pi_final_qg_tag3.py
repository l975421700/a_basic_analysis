...
# =============================================================================
# region import output: pi_final_qg_tag3
...
# =============================================================================
# region check water tagging: pi_final_qg_tag3
...
# =============================================================================
# region check water tagging: pi_final_qg_tag4

tagmap = xr.open_dataset('startdump/tagging/tagmap3/tagmap4.nc')
tag4_frc = (awi_esm_o[expid]['wiso']['wiso_am'].wisoaprl[0, 4, :, :] + awi_esm_o[expid]['wiso']['wiso_am'].wisoaprc[0, 4, :, :]) / (awi_esm_o[expid]['echam']['echam_am'].aprl[0, :, :] + awi_esm_o[expid]['echam']['echam_am'].aprc[0, :, :])
tag5_frc = (awi_esm_o[expid]['wiso']['wiso_am'].wisoaprl[0, 5, :, :] + awi_esm_o[expid]['wiso']['wiso_am'].wisoaprc[0, 5, :, :]) / (awi_esm_o[expid]['echam']['echam_am'].aprl[0, :, :] + awi_esm_o[expid]['echam']['echam_am'].aprc[0, :, :])
tag6_frc = (awi_esm_o[expid]['wiso']['wiso_am'].wisoaprl[0, 6, :, :] + awi_esm_o[expid]['wiso']['wiso_am'].wisoaprc[0, 6, :, :]) / (awi_esm_o[expid]['echam']['echam_am'].aprl[0, :, :] + awi_esm_o[expid]['echam']['echam_am'].aprc[0, :, :])
# tag5_frc.to_netcdf('output/scratch/trial.nc', mode='w')
...
fig.subplots_adjust(left=0.06, right=0.97, bottom=0.08, top=0.995)
fig.savefig('figures/6_awi/6.0_awi-esm-2.1-wiso/6.0.1_pi_final_qg_tag3/6.0.1.0_tag_frac/6.0.1.0.3_global am_tag4_pre_frc awi-esm-2.1-wiso pi_final_qg_tag4.png',)
...
fig.subplots_adjust(left=0.06, right=0.97, bottom=0.08, top=0.995)
fig.savefig('figures/6_awi/6.0_awi-esm-2.1-wiso/6.0.1_pi_final_qg_tag3/6.0.1.0_tag_frac/6.0.1.0.4_global am_tag5_pre_frc awi-esm-2.1-wiso pi_final_qg_tag4.png',)
...
cbar.ax.set_xlabel(
    'Fraction of pre from tag region 7 [$-$]\nAWI-ESM-2-1-wiso: pi_final_qg_tag4',
    linespacing=1.5
)

fig.subplots_adjust(left=0.06, right=0.97, bottom=0.08, top=0.995)
fig.savefig('figures/6_awi/6.0_awi-esm-2.1-wiso/6.0.1_pi_final_qg_tag3/6.0.1.0_tag_frac/6.0.1.0.5_global am_tag6_pre_frc awi-esm-2.1-wiso pi_final_qg_tag4.png',)
