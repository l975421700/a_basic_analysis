...
for irec in ['EC', 'JH', 'DC', 'MC']:
    ...
    for istation in lig_recs[irec].Station.unique():
        ...
        glat = HadISST1_1['sst'].sst[
            0, lig_recs_loc_indices_hadisst[irec][istation][0],
            lig_recs_loc_indices_hadisst[irec][istation][1]].latitude
        glon = HadISST1_1['sst'].sst[
            0, lig_recs_loc_indices_hadisst[irec][istation][0],
            lig_recs_loc_indices_hadisst[irec][istation][1]].longitude
