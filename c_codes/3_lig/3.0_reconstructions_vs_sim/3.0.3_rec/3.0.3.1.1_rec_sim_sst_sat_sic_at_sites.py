...
for irec in ['EC', 'JH', 'DC']:
    ...
    ax.scatter(
        ...
        s=20, c='white', edgecolors='k', lw=0.5, alpha=0.75,
        )
...
ax.scatter(
    ...
    s=20, c='white', edgecolors='b', lw=0.5, alpha=0.75,
    )
...
ax.set_ylabel('Simulated annual SST/SAT [$°C$]')
ax.set_ylim(axis_min, axis_max)
ax.set_yticks(np.arange(axis_min, axis_max + 1e-4, 2))
ax.yaxis.set_minor_locator(AutoMinorLocator(2))

ax.set_xlabel('Reconstructed annual SST/SAT [$°C$]')
