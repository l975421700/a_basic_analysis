...
with open(exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.epe_st_weighted_sinlon.pkl', 'rb') as f:
    epe_st_weighted_sinlon = pickle.load(f)

with open(exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.epe_st_weighted_coslon.pkl', 'rb') as f:
...
with open(exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.epe_st_weighted_lon.pkl',
          'wb') as f:
