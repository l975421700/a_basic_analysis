...
for icores in stations_sites.Site:
    ...
    for ialltime in ['mon', 'sea', 'ann', 'mm', 'sm']:
        ...
        for iqtl in quantiles.keys():
            ...
            d1=wisoaprt_masked_bin_icores[expid[i]][icores]['mean'][ialltime][iqtl]
            d2=wisoaprt_masked_bin[expid[i]]['mean'][iqtl][ialltime][
                    :,
                    t63_sites_indices[icores]['ilat'],
                    t63_sites_indices[icores]['ilon']]
            print((d1 == d2).all().values)
    ...
    for ialltime in ['am']:
        ...
        for iqtl in quantiles.keys():
            ...
            d1=wisoaprt_masked_bin_icores[expid[i]][icores]['mean'][ialltime][
                wisoaprt_masked_bin_icores[expid[i]][icores]['mean'][ialltime].iqtl == iqtl
            ].am.values
            d2=wisoaprt_masked_bin[expid[i]]['mean'][iqtl][ialltime][
                    t63_sites_indices[icores]['ilat'],
                    t63_sites_indices[icores]['ilon']].values
