...
pltlevel, pltticks, pltnorm, pltcmp = plt_mesh_pars(
    cm_min=0, cm_max=4, cm_interval1=0.5, cm_interval2=0.5, cmap='pink',
    reversed=True)
...
'''
(epe_weighted_sst[expid[i]][iqtl]['am'] - pre_weighted_sst[expid[i]]['am']).to_netcdf('scratch/test/test.nc')
'''
# endregion
# -----------------------------------------------------------------------------
