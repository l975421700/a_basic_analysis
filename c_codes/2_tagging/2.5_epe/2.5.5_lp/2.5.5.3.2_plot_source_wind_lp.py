...
lp_weighted_wind10 = {}
with open(exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.lp_weighted_wind10.pkl', 'rb') as f:
    lp_weighted_wind10[expid[i]] = pickle.load(f)

lpr_weighted_wind10 = {}
with open(exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.lpr_weighted_wind10.pkl', 'rb') as f:
    lpr_weighted_wind10[expid[i]] = pickle.load(f)

lon = lpr_weighted_wind10[expid[i]]['10%']['am'].lon
lat = lpr_weighted_wind10[expid[i]]['10%']['am'].lat
...
# -----------------------------------------------------------------------------
# region plot (lp_weighted_wind10 '10%'-lpr_weighted_wind10 '10%') am Antarctica
...
iqtl = '10%'
wind10_diff = lp_weighted_wind10[expid[i]][iqtl]['am'] - \
    lpr_weighted_wind10[expid[i]][iqtl]['am']
