...
lon = transport_distance_lpr[expid[i]]['10%']['am'].lon
lat = transport_distance_lpr[expid[i]]['10%']['am'].lat
...
# -----------------------------------------------------------------------------
# region plot (transport_distance_lp '10%'-transport_distance_lpr '10%') am Antarctica

iqtl = '10%'
plt_data = (transport_distance_lp[expid[i]][iqtl]['am'] - \
    transport_distance_lpr[expid[i]][iqtl]['am']) / 100
# plt_data.values[echam6_t63_ais_mask['mask']['AIS'] == False] = np.nan


output_png = 'figures/6_awi/6.1_echam6/6.1.7_epe/6.1.7.0_pre_source/6.1.7.0.5_travel_distance/6.1.7.0.5 ' + expid[i] + ' transport_distance_lp_10 - transport_distance_lpr_10 am Antarctica.png'
...
ttest_fdr_res = ttest_fdr_control(
    transport_distance_lp[expid[i]][iqtl]['ann'],
    transport_distance_lpr[expid[i]][iqtl]['ann'],
    )
ax.scatter(
...
cbar.ax.set_xlabel('Source-sink distance anomalies [$10^{2} \; km$]',
...
distance_diff = (transport_distance_lp[expid[i]][iqtl]['am'] - \
    transport_distance_lpr[expid[i]][iqtl]['am'])
