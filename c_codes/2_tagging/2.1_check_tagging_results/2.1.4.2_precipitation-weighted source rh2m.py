...
rh2m_scaled_pre[expid[i]] = (exp_org_o[expid[i]]['wiso'].wisoaprl.sel(wisotype=kstart+2) + exp_org_o[expid[i]]['wiso'].wisoaprc.sel(wisotype=kstart+2))

#---------------- monthly values

pre_weighted_rh2m[expid[i]] = rh2m_scaled_pre[expid[i]] / ocean_pre[expid[i]] * (maxrh2m[expid[i]] - minrh2m[expid[i]]) + minrh2m[expid[i]]
...
rh2m_scaled_pre_ann[expid[i]] = rh2m_scaled_pre[expid[i]].groupby('time.year').sum(dim="time", skipna=True)

pre_weighted_rh2m_ann[expid[i]] = rh2m_scaled_pre_ann[expid[i]] / ocean_pre_ann[expid[i]] * (maxrh2m[expid[i]] - minrh2m[expid[i]]) + minrh2m[expid[i]]
...
pltlevel2 = np.concatenate((np.arange(-20, -2 + 1e-4, 2), np.arange(2, 20 + 1e-4, 2)))
