...
wind10_scaled_pre[expid[i]] = (exp_org_o[expid[i]]['wiso'].wisoaprl.sel(wisotype=kstart+2) + exp_org_o[expid[i]]['wiso'].wisoaprc.sel(wisotype=kstart+2)).compute()[120:]

wind10_scaled_pre[expid[i]].values[ocean_pre[expid[i]] < 2e-8] = 0
...
wind10_scaled_pre_ann[expid[i]] = wind10_scaled_pre[expid[i]].groupby('time.year').mean(dim="time", skipna=True).compute()

#---- seasonal mean pre
ocean_pre_sea[expid[i]] = ocean_pre[expid[i]].groupby('time.season').mean(dim="time", skipna=True).compute()
wind10_scaled_pre_sea[expid[i]] = wind10_scaled_pre[expid[i]].groupby('time.season').mean(dim="time", skipna=True).compute()

#---- annual mean pre
ocean_pre_am[expid[i]] = ocean_pre[expid[i]].mean(dim="time", skipna=True).compute()
wind10_scaled_pre_am[expid[i]] = wind10_scaled_pre[expid[i]].mean(dim="time", skipna=True).compute()


#---------------- monthly values

pre_weighted_wind10[expid[i]] = (wind10_scaled_pre[expid[i]] / ocean_pre[expid[i]] * (maxwind10[expid[i]] - minwind10[expid[i]]) + minwind10[expid[i]]).compute()
pre_weighted_wind10[expid[i]].values[ocean_pre[expid[i]] < 2e-8] = np.nan
...
pre_weighted_wind10_ann[expid[i]] = (wind10_scaled_pre_ann[expid[i]] / ocean_pre_ann[expid[i]] * (maxwind10[expid[i]] - minwind10[expid[i]]) + minwind10[expid[i]]).compute()
pre_weighted_wind10_ann[expid[i]].values[ocean_pre_ann[expid[i]].values < 2e-8] = np.nan
...
pre_weighted_wind10_sea[expid[i]] = (wind10_scaled_pre_sea[expid[i]] / ocean_pre_sea[expid[i]] * (maxwind10[expid[i]] - minwind10[expid[i]]) + minwind10[expid[i]]).compute()
pre_weighted_wind10_sea[expid[i]].values[ocean_pre_sea[expid[i]].values < 2e-8] = np.nan
...
pre_weighted_wind10_am[expid[i]] = (wind10_scaled_pre_am[expid[i]] / ocean_pre_am[expid[i]] * (maxwind10[expid[i]] - minwind10[expid[i]]) + minwind10[expid[i]]).compute()
pre_weighted_wind10_am[expid[i]].values[ocean_pre_am[expid[i]].values < 2e-8] = np.nan
...
pltlevel2 = np.arange(-4, 4 + 1e-4, 0.5)
