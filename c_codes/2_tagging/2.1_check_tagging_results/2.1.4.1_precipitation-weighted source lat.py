...
lat_scaled_pre[expid[i]] = (exp_org_o[expid[i]]['wiso'].wisoaprl.sel(wisotype=kstart+2) + exp_org_o[expid[i]]['wiso'].wisoaprc.sel(wisotype=kstart+2))
...
pltlevel2 = np.concatenate((np.arange(-10, -2 + 1e-4, 2), np.arange(2, 10 + 1e-4, 2)))
