...
pearsonr(
    pre_weighted_var[expid[i]]['lat']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
    pre_weighted_var[expid[i]]['sst']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
)
# PearsonRResult(statistic=0.9635111986045921, pvalue=0.0)

pearsonr(
    pre_weighted_var[expid[i]]['lat']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
    pre_weighted_var[expid[i]]['rh2m']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
)
# PearsonRResult(statistic=-0.9299568995122842, pvalue=0.0)

pearsonr(
    pre_weighted_var[expid[i]]['lat']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
    pre_weighted_var[expid[i]]['wind10']['am'].values[echam6_t63_ais_mask['mask']['AIS']],
)
