...
for var_name in ['dD', 'd18O', 'd_xs', 'd_ln', 'q']:
    ...
    output_png = 'figures/8_d-excess/8.3_vapour/8.3.0_obs_vs_sim/8.3.0.2_BJ19/8.3.0.2.0 ' + expid[i] + ' BJ19 observed vs. simulated daily ' + var_name + '.png'
    
    fig, ax = plt.subplots(1, 1, figsize=np.array([8.8, 8.8]) / 2.54)
    
    xdata = BJ19_polarstern_1d_sim[expid[i]][var_name]
    ydata = BJ19_polarstern_1d_sim[expid[i]][var_name + '_sim']
...
for var_name in ['dD', 'd18O', 'd_xs', 'd_ln', 'q']:
    ...
    output_png = 'figures/8_d-excess/8.3_vapour/8.3.0_obs_vs_sim/8.3.0.2_BJ19/8.3.0.2.0 ' + expid[i] + ' BJ19 observed vs. simulated daily ' + var_name + '_SH.png'
    
    fig, ax = plt.subplots(1, 1, figsize=np.array([8.8, 8.8]) / 2.54)
    
    xdata = BJ19_polarstern_1d_sim_SH[var_name]
    ydata = BJ19_polarstern_1d_sim_SH[var_name + '_sim']
    subset = (np.isfinite(xdata) & np.isfinite(ydata))
    xdata = xdata[subset]
    ydata = ydata[subset]
