...
CB19_DDU_1d_sim[expid[i]] = CB19_DDU['1d'].copy()
...
for var_name in ['dD', 'd18O', 'd_xs', 'd_ln', 'q',]:
    ...
    CB19_DDU_1d_sim[expid[i]][var_name + '_sim'] = \
        find_multi_gridvalue_at_site_time(
...
output_file = exp_odir + expid[i] + '/analysis/echam/' + expid[i] + '.CB19_DDU_1d_sim.pkl'

if (os.path.isfile(output_file)):
    os.remove(output_file)

with open(output_file, 'wb') as f:
    pickle.dump(CB19_DDU_1d_sim[expid[i]], f)
...
ires = 20
stime = CB19_DDU_1d_sim[expid[i]]['time'][ires]
slat = CB19_DDU_1d_sim[expid[i]]['lat'][ires]
slon = CB19_DDU_1d_sim[expid[i]]['lon'][ires]
...
print(CB19_DDU_1d_sim[expid[i]][var_name + '_sim'][ires])
