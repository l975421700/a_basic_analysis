...
for iisotopes in ['dO18', 'dD', 'd_ln', 'd_excess',]:
    ...
    output_png = 'figures/8_d-excess/8.0_records/8.0.3_isotopes/8.0.3.0_sim_vs_obs/8.0.3.0.2 ' + expid[i] + ' all grouped observed vs. simulated ' + iisotopes + '.png'
...
MD08_height = find_multi_gridvalue_at_site(
...
for iisotopes in ['dO18', 'dD', 'd_ln', 'd_excess',]:
    ...
    output_png = 'figures/8_d-excess/8.0_records/8.0.3_isotopes/8.0.3.0_sim_vs_obs/8.0.3.0.2 ' + expid[i] + ' all grouped observed vs. simulated ' + iisotopes + '_height1500.png'
    ...
    for i in range(len(expid)):
        ...
        xdata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes]
        ydata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes + '_sim']
        subset = (np.isfinite(xdata) & np.isfinite(ydata) & (MD08_height >= 1500))
        xdata = xdata[subset]
        ydata = ydata[subset]
        RMSE = np.sqrt(np.average(np.square(xdata - ydata)))
...
for iisotopes in ['dO18', 'dD', 'd_ln', 'd_excess',]:
    ...
    output_png = 'figures/8_d-excess/8.0_records/8.0.3_isotopes/8.0.3.0_sim_vs_obs/8.0.3.0.2 ' + expid[i] + ' all grouped observed vs. simulated ' + iisotopes + '_height2250.png'
    ...
    for i in range(len(expid)):
        ...
        xdata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes]
        ydata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes + '_sim']
        subset = (np.isfinite(xdata) & np.isfinite(ydata) & (MD08_height >= 2250))
        xdata = xdata[subset]
        ydata = ydata[subset]
        RMSE = np.sqrt(np.average(np.square(xdata - ydata)))
...
MD08_SLM = find_multi_gridvalue_at_site(
    Antarctic_snow_isotopes_sim_grouped_all[expid[i]]['lat'].values,
    Antarctic_snow_isotopes_sim_grouped_all[expid[i]]['lon'].values,
...
for iisotopes in ['dO18', 'dD', 'd_ln', 'd_excess',]:
    ...
    output_png = 'figures/8_d-excess/8.0_records/8.0.3_isotopes/8.0.3.0_sim_vs_obs/8.0.3.0.2 ' + expid[i] + ' all grouped observed vs. simulated ' + iisotopes + '_SLM.png'
    ...
    for i in range(len(expid)):
        ...
        xdata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes]
        ydata = Antarctic_snow_isotopes_sim_grouped_all[expid[i]][iisotopes + '_sim']
        subset = (np.isfinite(xdata) & np.isfinite(ydata) & (MD08_SLM == 1))
        xdata = xdata[subset]
        ydata = ydata[subset]
        RMSE = np.sqrt(np.average(np.square(xdata - ydata)))
