...
pltlevel, pltticks, pltnorm, pltcmp = plt_mesh_pars(
    cm_min=-70, cm_max=0, cm_interval1=5, cm_interval2=10,
...
for jcol in range(ncol):
    ...
    plt1 = plot_t63_contourf(
        ...
        (d_ln_alltime[expid[jcol]]['am'] * 1000).sel(lat=slice(-57, -90)),
        axs[jcol],
        pltlevel, 'both', pltnorm, pltcmp, ccrs.PlateCarree(),)
...
pltlevel2, pltticks2, pltnorm2, pltcmp2 = plt_mesh_pars(
    cm_min=-30, cm_max=30, cm_interval1=1, cm_interval2=10,
...
plt1 = plot_t63_contourf(
    lon, lat.sel(lat=slice(-57, -90)),
    (d_ln_alltime[expid[0]]['am'] * 1000).sel(lat=slice(-57, -90)),
...
for jcol in np.arange(1, 4, 1):
    ...
    plt2 = plot_t63_contourf(
        lon, lat.sel(lat=slice(-57, -90)),
        ((d_ln_alltime[expid[jcol]]['am'] - d_ln_alltime[expid[0]]['am']) * 1000).sel(lat=slice(-57, -90)),
