...
# -----------------------------------------------------------------------------
# region Corr. aprt & source latitude
...
for i in range(len(expid)):
    ...
    cor_aprt_ivar[expid[i]].values[cor_aprt_ivar_p[expid[i]] > 0.05] = np.nan
...
output_png = 'figures/8_d-excess/8.1_controls/8.1.1_pre_sources/8.1.1.0 pi_600_3 corr. aprt and ' + ivar + ' mon.png'
...
# -----------------------------------------------------------------------------
# region Corr. aprt & source wind10
